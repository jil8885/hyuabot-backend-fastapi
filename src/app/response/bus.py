...
class RouteTimetableResponse(BaseModel):
...
class Location(BaseModel):
    ...
    district_code: int = Field(..., alias='district')
    region_name: str = Field(..., alias='region')
...
class StopArrivalResponse(StopResponse):
    route: list[RouteArrivalResponse] | None = Field(..., alias='route')


class StopTimetableResponse(StopResponse):
    route: list[RouteTimetableResponse] | None = Field(..., alias='route')
