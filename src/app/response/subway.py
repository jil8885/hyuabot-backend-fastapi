...
class StationListItemResponse(BaseModel):
    id: str = Field(..., alias='id')
    name: str = Field(..., alias='name')
    line: int = Field(..., alias='line')


class LineListItemResponse(BaseModel):
    id: int = Field(..., alias='id')
    name: str = Field(..., alias='name')
    station_list: list[str] = Field(..., alias='stations')


class StationItemResponse(BaseModel):
    id: str = Field(..., alias='id')
    name: str = Field(..., alias='name')
    line: int = Field(..., alias='line')
    sequence: int = Field(..., alias='sequence')
    cumulative_time: datetime.timedelta = Field(..., alias='cumulative_time')
...
class StationListResponse(BaseModel):
    stations: list[StationListItemResponse] = Field(..., alias='stations')
